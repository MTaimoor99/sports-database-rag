...
#ReAct Tool
@tool
async def get_live_scores(league_id: int | None = None) -> dict:
    ...
    """
    return await football_service.get_live_scores(league_id)

#RAG tool
@tool
async def search_historical_data(query: str) -> dict:
    """
...
async def search_team(name: str) -> dict:
    ...
    """
    return await football_service.search_team(name)